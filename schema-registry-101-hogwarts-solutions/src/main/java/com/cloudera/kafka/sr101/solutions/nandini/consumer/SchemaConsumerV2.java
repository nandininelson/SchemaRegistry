...
public class SchemaConsumerV2 {

    public static final Logger logger = LoggerFactory.getLogger(SchemaConsumerV2.class.getName());
    public static void main(String[] args)  throws Exception {
        ...
        readerVersions.put(SCHEMA_NAME, 2/*SCHEMA_VERSION*/);
            ...
            while (true) {
                ...
                for (ConsumerRecord<Long, Object> record : records) {
                    ...
                    System.out.println(", Value: { xid = " + avroRecord.get("xid") +
                            ...
                            " batteryPercentage = " + avroRecord.get("batteryPercentage") + " }"
                                );
                }
                // commit offsets
                consumer.commitSync();
